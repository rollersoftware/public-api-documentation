...
1. Using the [**Payments**](https://docs.roller.app/docs/api/rest/operations/add-transaction-record) endpoint.
2. Using the [**Cancel a booking**](https://docs.roller.app/docs/api/rest/operations/cancel-a-booking) endpoint.
...
3. Later, the booking is cancelled:
   ...
   2. You then cancel the booking via [**Cancel a booking**](https://docs.roller.app/docs/api/rest/operations/cancel-a-booking) and include the refund transaction details, which logs the refund in ROLLER.
