...
1. Using the [**Payments**](../reference/rest-api.yaml) endpoint.
2. Using the [**Cancel a booking**](../reference/rest-api.yaml) endpoint.
...
3. Later, the booking is cancelled:
   ...
   2. You then cancel the booking via [**Cancel a booking**](../reference/rest-api.yaml) and include the refund transaction details, which logs the refund in ROLLER.
