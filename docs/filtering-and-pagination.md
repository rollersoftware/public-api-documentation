...
<!-- theme: warning -->
> The [**Get revenue entries**](../reference/reporting-api.yaml/paths/~1reporting~1revenue-entries/get) endpoint is an exception and **does not** filter based on modified date — it filters based on the **event date**.
>
