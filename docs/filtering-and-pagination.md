...
<!-- theme: warning -->
> The [**Get revenue entries**](../reference/reporting-api.yaml) endpoint is an exception and **does not** filter based on modified date — it filters based on the **event date**.
>
