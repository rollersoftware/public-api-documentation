...
# Filtering and Pagination [Reporting API]
...
<!-- theme: warning -->
> The [**Get revenue entries**](https://docs.roller.app/docs/api/reporting/operations/get-revenue-entries) endpoint is an exception and **does not** filter based on modified date — it filters based on the **event date**.
>
